...
public class Base : MonoBehaviour
{
    ...
    private GameObjectManager m_GameObjectMgr;
    ...
    protected AssetManager assetManager
    {
        get
        {
            if (m_AssetMgr == null)
            {
                m_AssetMgr = facade.GetManager<AssetManager>(ManagerName.Asset);
            }
            return m_AssetMgr;
        }
    }
    ...
    protected GameObjectManager gameObjectManager
    {
        get
        {
            ...
            {
                m_GameObjectMgr = facade.GetManager<GameObjectManager>(ManagerName.Object);
            }
