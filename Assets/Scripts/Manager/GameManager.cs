...
public class GameManager : Manager
{
    ...
    {
        bool isExists = Directory.Exists(PathConst.DataPath) &&
          Directory.Exists(PathConst.DataPath + "lua/") && File.Exists(PathConst.DataPath + "files.txt");
        if (isExists || PathConst.DebugMode)
        {
    ...
    {
        string dataPath = PathConst.DataPath;  //数据目录
        string resPath = PathConst.AppContentPath(); //游戏包资源目录
    ...
    {
#if ASYNC_MODE
        assetManager.Initialize(PathConst.AssetDir, delegate()
        {
